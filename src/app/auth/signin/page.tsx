    ...
    <main className="min-h-screen bg-zen-bg flex items-center justify-center p-4">
      <div className="max-w-sm w-full">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-zen-border rounded-xl text-zen-text-primary hover:bg-gray-50 transition-colors mb-4 cursor-pointer"
        >
        ...
        <p className="text-center text-sm text-zen-text-secondary mt-6">
          アカウントをお持ちでない方は{" "}
          <Link href="/auth/signup" className="text-zen-accent-red font-medium hover:underline">
            新規登録
          </Link>
        </p>
